...
<div class="headline_cont fw">
	<h2>Add Newsletter Template</h2>		
</div>
<?php echo $this->Form->create('newsletters', array('type' => 'post', 'action' => 'add_newsletter', 'name' => 'addNewsletterForm', 'id' => 'addNewsletterForm')); ?>
<div class="">
	<label>Newsletter Used For</label>
	...
	<?php echo $this->Form->input('Newsletter.mail_body', array('type' => 'textarea', 'rows' => 10, 'cols' => 50, 'label' => false, 'div' => false, 'required' => true, 'class' => 'form-control'));
