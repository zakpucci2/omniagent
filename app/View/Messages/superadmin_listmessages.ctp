    ...
    <div class="col-lg-12 ch-heading">
        <div class="row">
            ...
            <div class="pull-right">
				<?php echo $this->Html->link('<i class="glyphicon glyphicon-envelope"></i> Sent Messages', array('controller' => 'messages', 'action' => 'sentmessages', 'superadmin' => true), array('escape' => false, 'class' => 'btn btn-lmd btn-success', 'title' => 'Sent Messages', 'id' => 'sentMessages')); ?>
                    ...
                    <tbody>
						...
						if (isset($data) && !empty($data)) {
							foreach ($data as $message_data) {
								if($message_data['UserMessage']['is_read'] == 0) { 
									$class = 'class="boldtr"';
								} else {
									$class = '';
								}
								...
								<tr <?php echo $class; ?>>
									...
									<td class="td-actions">
										...
										<?php echo $this->Html->link('<i class="glyphicon glyphicon-envelope"></i> ', array('controller' => 'messages', 'action' => 'view_message', base64_encode($message_data['Message']['id'])), array('escape' => false, 'class' => 'btn btn-xs btn-info viewRow', 'title' => 'View Message Detail')); ?>
...
<?php echo $this->Element('message/superadmin_view_message'); ?>
<!-- Modal Send Message-->
