...
<?php $this->Html->addCrumb('Sent Messages', array('controller' => 'messages', 'action' => 'sentmessages')); ?>
<style type="text/css">
	.custab{
...
<div class="row-fluid">
	<a href="#messageSettings" data-toggle="modal" class="btn btn-setting btn-warning"><i class="halflings-icon white cog"></i> Settings</a>&nbsp;&nbsp;
	<?php echo $this->Html->link('<i class="halflings-icon white envelope"></i> Messages', array('controller' => 'messages', 'action' => 'listmessages'), array('escape' => false, 'class' => 'btn btn-success', 'title' => 'Messages', 'id' => 'listMessages')); ?>
	...
	<table class="table table-striped custab">
		...
		<thead>
			<tr>
				...
				<th scope="col"><?php echo $this->Paginator->sort('UserMessage.receiver_id', 'To'); ?></th>
			...
			if (isset($data) && !empty($data)) {
				...
				foreach ($data as $message_data) {
					...
					<tr>
						...
						<td scope="col"><?php echo $message_data['Receiver']['first_name'] . ' ' . $message_data['Receiver']['last_name']; ?></td>
						<td scope="col">
						...
						<td scope="col" class="text-center">
							<?php echo $this->Html->link('<i class="halflings-icon white search"></i> View', array('controller' => 'messages', 'action' => 'view_sent_message', base64_encode($message_data['Message']['id'])), array('escape' => false, 'class' => 'btn btn-info btn-md viewSentRow', 'title' => 'View Sent Message Detail')); ?>
...
<?php echo $this->Element('message/view_sent_message'); ?>
<!-- Modal Send Message-->
