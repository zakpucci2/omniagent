<div class="modal fade" id="replyTicketModalHis" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			...
			<div class="modal-body">
				...
				<center>
					<div class="input-group">
						...
						<input type="text" id="MessageReceiverUserName" class="form-control" maxlength="100" name="data[Message][receiver_user_name]" readonly="readonly" style="width:76%" required="required" value="<%= ticket_data.User.user_name %>" placeholder= "Type a user or admin name..." />@<?php echo Configure::read('SITE_EMAIL.Email'); ?>
					</div><br>
					<div class="input-group">
						<span class="input-group-addon">Subject</span>
						<input type="text" id="MessageSubject" class="form-control" maxlength="255" name="data[Message][subject]" value="Re: <%= ticket_data.SupportTicket.subject %>" required="required" placeholder= "Message Subject" />
					</div><br>
					<div class="input-group">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $(".editTicketHisRow").live(function (event) {
            ...
            $.getJSON(urlLoc, function (data) {
                ...
                $('#replyTicketModalHis').modal('show');
            });
        });
