			...
			<div class="modal-body">
				<center>
					<div class="input-group">
						...
						<input type="text" id="MessageReceiverUserName" class="form-control" maxlength="100" readonly="readonly" required="required" value="<%= message_data.Sender.user_name + '@' %><?php echo Configure::read('SITE_EMAIL.Email'); ?> [<%= message_data.Sender.first_name + ' ' + message_data.Sender.last_name %>]" />
					</div><br>
					<div class="input-group">
