	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">View Sent Message Details</h4>
			</div>
			<div class="modal-body">
				<center>
					<div class="input-group">
						<span class="input-group-addon">To</span>
						<input type="text" id="MessageReceiverUserName" class="form-control" maxlength="100" readonly="readonly" required="required" value="<%= message_data.Receiver.user_name + '@' %><?php echo Configure::read('SITE_EMAIL.Email'); ?> [<%= message_data.Receiver.first_name + ' ' + message_data.Receiver.last_name %>]" />
					</div><br>
					<div class="input-group">
						<span class="input-group-addon">Sent On</span>
