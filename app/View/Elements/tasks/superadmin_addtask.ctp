			...
			<div class="modal-body">
				<center>
					...
					<div class="input-group">
						...
						<?php echo $this->Form->input('Task.info1', array('type' => 'text', 'label' => false, 'div' => false, 'maxlength' => 255, 'required' => true, 'class' => 'form-control', 'placeholder' => 'Ex: Facebook URL')); ?> 
					</div><br>
					<div class="input-group">
						<span class="input-group-addon">Required Info 2</span>
						<?php echo $this->Form->input('Task.info2', array('type' => 'text', 'label' => false, 'div' => false, 'maxlength' => 255, 'required' => true, 'class' => 'form-control', 'placeholder' => 'Ex: Content Theme')); ?> 
					</div><br>
					<div class="input-group">
						<span class="input-group-addon">Required Info 3</span>
						<?php echo $this->Form->input('Task.info3', array('type' => 'text', 'label' => false, 'div' => false, 'maxlength' => 255, 'required' => true, 'class' => 'form-control', 'placeholder' => 'Ex: Content Topic')); ?> 
					</div><br>
					<div class="input-group">
						<span class="input-group-addon">Required Info 4</span>
						<?php echo $this->Form->input('Task.info4', array('type' => 'text', 'label' => false, 'div' => false, 'maxlength' => 255, 'required' => true, 'class' => 'form-control', 'placeholder' => 'Ex: Content Length')); ?> 
					</div><br>
					<div class="input-group">
						<span class="input-group-addon">Required Info 5</span>
						<?php echo $this->Form->input('Task.file', array('type' => 'file', 'label' => false, 'div' => false, 'maxlength' => 255, 'required' => true, 'class' => 'form-control')); ?> 
					</div>
				</center>
			</div>
