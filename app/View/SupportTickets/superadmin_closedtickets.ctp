...
<div><br>
    <div class="col-lg-12 ch-heading">
        <div class="row">
            <div class="pull-left"><strong class="lead"><i class="glyphicon glyphicon-floppy-saved"></i> Closed Support Tickets</strong></div>
            <div class="pull-right">
				<?php echo $this->Html->link('<i class="glyphicon glyphicon-file"></i> Support Tickets', array('controller' => 'support_tickets', 'action' => 'listtickets', 'superadmin' => true), array('escape' => false, 'class' => 'btn btn-lmd btn-success', 'title' => 'Support Tickets', 'id' => 'listTickets')); ?>
            </div>
        </div>
    </div>
    <br><br>
	<?php echo $this->Form->create('support_tickets', array('action' => 'closedtickets', 'type' => "GET"), array('class' => "control-group")); ?>
                ...
                <table class="table table-striped table-bordered">
                    <thead>
                        <tr>
							...
							<th><?php echo $this->Paginator->sort('SupportTicket.closed_date', 'Closed On'); ?></th>
                            <th>Actions</th>
                        </tr>
                    </thead>
                    <tbody>
						...
						if (isset($data) && !empty($data)) {
							...
							foreach ($data as $supportticket_data) {
								...
								<tr>
									...
									<?php
										$admin = '';
										echo $supportticket_data['Admin']['first_name'] . " " . $supportticket_data['Admin']['last_name'];
									?>
									</td>
									<td><?php echo $supportticket_data['SupportTicket']['date']; ?></td>
									<td><?php echo $supportticket_data['SupportTicket']['close_date']; ?></td>
									<td class="td-actions">
