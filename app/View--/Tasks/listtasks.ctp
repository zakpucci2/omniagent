					...
					if (isset($data) && !empty($data)) {
						...
						foreach ($data as $task_data) {
							...
							<tr>
								...
								<td><a href="<?php echo $this->webroot;?>tasks/view_task/<?php echo base64_encode($task_data['UserTask']['task_id']);?>" class="viewTaskBadgeRow btn btn2 btn-info btn-md viewRow " title="View Task"><i class="halflings-icon white search"></i>View</a></td>
							</tr>
							<?php
							$counter++;
						}
