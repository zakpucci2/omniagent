    ...
    <div class="col-lg-12 ch-heading">
        <div class="row">
            ...
            <div class="pull-right">
				<?php echo $this->Html->link('<i class="glyphicon glyphicon-envelope"></i> Sent Messages', array('controller' => 'messages', 'action' => 'sentmessages', 'admin' => true), array('escape' => false, 'class' => 'btn btn-lmd btn-success', 'title' => 'Sent Messages', 'id' => 'sentMessages')); ?>
							...
							foreach ($data as $message_data) {
								...
								<tr <?php echo $class; ?>>
									...
									<td class="td-actions">
										...
										<?php echo $this->Html->link('<i class="glyphicon glyphicon-envelope"></i> ', array('controller' => 'messages', 'action' => 'view_message', base64_encode($message_data['Message']['id']), 'admin' => true), array('escape' => false, 'class' => 'btn btn-xs btn-info viewRow', 'title' => 'View Message Detail')); ?>
...
<?php echo $this->Element('message/admin_view_message'); ?>
<!-- Modal Send Message-->
