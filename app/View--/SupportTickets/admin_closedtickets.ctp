    ...
    <div class="col-lg-12 ch-heading">
        <div class="row">
            ...
            <div class="pull-right">
				<?php echo $this->Html->link('<i class="glyphicon glyphicon-file"></i> Support Tickets', array('controller' => 'support_tickets', 'action' => 'listtickets', 'admin' => true), array('escape' => false, 'class' => 'btn btn-lmd btn-success', 'title' => 'Support Tickets', 'id' => 'listTickets')); ?>
            </div>
        </div>
    </div>
    <br><br>
                ...
                <table class="table table-striped table-bordered">
                    <thead>
                        <tr>
							...
							<th><?php echo $this->Paginator->sort('SupportTicket.created', 'Closed On'); ?></th>
                            <th>Actions</th>
                        </tr>
                    </thead>
                    <tbody>
