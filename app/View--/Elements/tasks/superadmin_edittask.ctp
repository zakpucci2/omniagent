		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<center>
					...
					<div class="input-group">
						<span class="input-group-addon">Required Info 1</span>
						<input type="text" id="TaskInfo1" class="form-control" maxlength="255" name="data[Task][info1]" value="<%= task_data.Task.info1 %>" required="required" placeholder= "Ex. Facebook URL" />
					</div><br>
					<div class="input-group">
						<span class="input-group-addon">Required Info 2</span>
						<input type="text" id="TaskInfo2" class="form-control" maxlength="255" name="data[Task][info2]" value="<%= task_data.Task.info2 %>" required="required" placeholder= "Ex. Content Theme" />
					</div><br>
					<div class="input-group">
						<span class="input-group-addon">Required Info 3</span>
						<input type="text" id="TaskInfo3" class="form-control" maxlength="255" name="data[Task][info3]" value="<%= task_data.Task.info3 %>" required="required" placeholder= "Ex. Content Topic" />
					</div><br>
					<div class="input-group">
						<span class="input-group-addon">Required Info 4</span>
						<input type="text" id="TaskInfo4" class="form-control" maxlength="255" name="data[Task][info4]" value="<%= task_data.Task.info4 %>" required="required" placeholder= "Ex. Content Length" />
					</div><br>
					<div class="input-group">
						<span class="input-group-addon">Required Info 5</span>
						<input type="file" id="TaskFile" class="form-control" maxlength="255" name="data[Task][file]" />
							<% if(task_data.Task.info5 != "") { %>
							<p>
								<a href="<?php echo Router::url('/', true) . 'files/' ?><%= task_data.Task.info5 %>"><%= task_data.Task.info5 %></a>
							</p>
							<% } %>
					</div><br />
				</center>
