<div class="modal fade" id="newmessageModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<?php echo $this->Form->create('messages', array('type' => 'post', 'action' => 'superadmin_compose_message', 'name' => 'UserComposeMessageForm', 'id' => 'UserComposeMessageForm', 'role' => 'form', 'class' => 'form-horizontal')); ?>
			...
			<div class="modal-body">
				<center>
					...
					<div class="input-group">
						...
						<?php echo $this->Form->textarea('Message.body', array('label' => false, 'div' => false, 'row' => 6, 'class' => 'form-control', 'required' => true, 'placeholder' => 'Message body')); ?>
					</div><br>
				</center>
			</div>
