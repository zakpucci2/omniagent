	...
	$(".todo-list").find('.action').each(function() {
            $(this).click(function() {
                if ($(this).hasClass('icon-check-empty')) {
                    ...
                    var val= splitarr[1];
                    $.post( SITE_URL + "users/updatetask", { taskId: taskId,value:val ,type:'complete'} );
                    ...
                    var taskId = splitarr[0];
                    var val= splitarr[1];
                    $.post( SITE_URL + "users/updatetask", {taskId: taskId,value:val,type:'reopen'} );
